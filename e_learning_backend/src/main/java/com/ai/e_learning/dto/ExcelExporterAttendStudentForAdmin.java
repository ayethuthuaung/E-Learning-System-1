...
@Component
public class ExcelExporterAttendStudentForAdmin {
    ...
    public void exportAttendStudentList(HttpServletResponse response) throws IOException {
        // Fetch all accepted user courses
        ...
        Sheet sheet = workbook.createSheet("Attended Students");
        ...
        String headerValue = "attachment; filename=attended_students_" + currentDateTime + ".xls";
