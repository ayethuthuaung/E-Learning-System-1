...
////            createCourseCells(row, course, formatter, workbook);
////
...
////                createStudentCells(row, userCourse);
////            }
////        }
////
...
////    }
////
////    private void createCourseCells(Row row, CourseDto course, DateTimeFormatter formatter, HSSFWorkbook workbook) {
////        Cell cell = row.createCell(0);
////        cell.setCellValue("Instructor");
////
////        cell = row.createCell(1);
////        cell.setCellValue(course.getUser().getName());
////
////        cell = row.createCell(2);
////        cell.setCellValue(course.getUser().getEmail());
////
////        cell = row.createCell(3);
////        cell.setCellValue(""); // Instructor does not have a status
////
////        cell = row.createCell(4);
////        cell.setCellValue(""); // Instructor does not have a team
////
////        cell = row.createCell(5);
////        cell.setCellValue(""); // Instructor does not have a department
////
////        cell = row.createCell(6);
////        cell.setCellValue(""); // Instructor does not have a division
////
...
////        wrapText(cell, workbook); // Wrap text in course description
////
...
////    }
////
////    private void createStudentCells(Row row, UserCourseDto userCourse) {
////        Cell cell = row.createCell(0);
...
////
////        cell = row.createCell(7);
////        cell.setCellValue(""); // Student row does not have course details
////
////        cell = row.createCell(8);
////        cell.setCellValue("");
////
...
//            for (UserCourseDto userCourse : courseUserCourses) {
//                Row row = sheet.createRow(rowCount++);
//                createStudentCells(row, userCourse, course, formatter);
//            }
//        }
//
//        for (int i = 0; i < 9; i++) { // Adjust the loop limit to account for all columns
//            sheet.autoSizeColumn(i);
//        }
//
//        // Set content type and header for the response
...
//    }
//
//    private void createStudentCells(Row row, UserCourseDto userCourse, CourseDto course, DateTimeFormatter formatter) {
//        UserDto user = new UserDto(userCourse.getUser());
//
//        Cell cell = row.createCell(0);
//        cell.setCellValue(userCourse.getUser().getName());
