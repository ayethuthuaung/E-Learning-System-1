...
public interface ChatService {
    ChatMessageDto sendMessage(Long chatRoomId, Long senderId, String content, String file, String messageType, String sessionId)throws IOException, GeneralSecurityException;
